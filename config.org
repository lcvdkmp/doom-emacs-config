...
#+end_src
* Language Server
Disable lsp's lensen for now, as they clutter the buffer to much.
#+begin_src elisp
...
:END:"
  ...
  (org-ditaa-jar-path "~/.doom.d/scripts/ditaa.jar")
...
** Defer academic-phrases
#+begin_src elisp
(use-package! academic-phrases
  ;; :hook (text-mode tex-mode)
  :defer
  )
#+end_src
